...
int getHashCode(const char* identifier){
    return (int(identifier[0]) + int(identifier[1]) + int(identifier[strlen(identifier)-1])); //HashFunc
}
...
hashTableEntry* getHashTable(const char* fileName, int size, int maxlength){
    ...
    ifstream identifiers(fileName); //Object of reading
...
int main(){
    ...
    //generateFile(100000, "/Users/konstafer/ITMO-FILES/Course 2/Algorithms and data structures/AlgLab1/identifiers.dat", 3, 32);
    hashTableEntry* hashTable = getHashTable("/Users/konstafer/ITMO-FILES/Course 2/Algorithms and data structures/AlgLab1/identifiers.dat",367,32);
    hashTableEntry* tableEntry = searchEntry("sqcfzlvkdl", hashTable);
    string identifier;
