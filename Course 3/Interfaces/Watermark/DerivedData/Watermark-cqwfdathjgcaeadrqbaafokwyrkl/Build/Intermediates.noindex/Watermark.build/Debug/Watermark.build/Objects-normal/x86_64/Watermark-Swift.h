...
SWIFT_MODULE_NAMESPACE_PUSH("Watermark")

SWIFT_CLASS("_TtC9Watermark11AppDelegate")
...
SWIFT_CLASS("_TtC9Watermark14ViewController")
@interface ViewController : NSViewController
@property (nonatomic, weak) IBOutlet NSImageView * _Null_unspecified imageWell;
- (IBAction)buttonOpenImage:(id _Nonnull)sender;
- (IBAction)buttonEdit:(id _Nonnull)sender;
- (IBAction)buttonSave:(id _Nonnull)sender;
- (void)viewDidLoad;
